...
The test command enqueues a signed `webhook.test` delivery. Delivery receipts expose queue state, attempt count, receiver status, timestamps, and the last retained error.
